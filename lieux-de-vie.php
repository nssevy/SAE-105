        ...
        <main class="conteneur-principal">
            ...
            <section class="ldv">
                ...
                <section class="bibliothèque, box">
                    <div class="contenu">
                    <img src="ressources/images/bu.jpeg" alt="Bibliothèque universitaire">
                        <div class="texte">
                ...
                <section class="restauration, box">
                    <div class="contenu">
                    <img src="ressources/images/restauration.jpeg" alt="Se restaurer">
                        <div class="texte">
                            <h2>Se restaurer</h2>
                            <p>
                ...
                <section class="fablabs, box">
                    <div class="contenu">
                    <img src="ressources/images/fablabs.jpeg" alt="Réseau des fablabs de CY Cergy Paris Université">
                        <div class="texte">
